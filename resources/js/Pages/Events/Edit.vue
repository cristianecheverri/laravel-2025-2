...
onMounted(() => {
    ...
    if (props.event.event_date) {
        ...
        // Configurar fecha y hora actual como valor predeterminado si no hay fecha
        const now = new Date();
                        ...
                        <form @submit.prevent="submit">
                            ...
                            <div class="mb-4">
                                ...
                                <div v-if="props.event.event_image" class="mt-2">
                                    ...
                                    <img :src="'/storage/' + props.event.event_image" alt="Current Event Image" class="mt-1 max-w-xs h-auto rounded-md shadow-sm"/>
                                </div>
                            </div>
